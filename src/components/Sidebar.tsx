            ...
            <div className="glass-panel rounded-2xl p-6 pointer-events-auto flex flex-col gap-5 transition-all duration-300 hover:shadow-lg">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h1 className="text-xl font-bold tracking-tight text-slate-900">VisaMap</h1>
                    </div>
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Find the perfect location for your H1B visa application based on prevailing wages.
                    </p>
                </div>
